...
if __name__ == "__main__":
    ...
    exp_names = ["3DCE_3_image_3_slice", "3DCE_5_image_3_slice", "3DCE_7_image_3_slice"]
    lesion_sizes = ["lt_10", "gte_10_lte_30", "gt_30_lte_50", "gt_50_lte_70", "gt_70_lte_100", "gt_100"]
    proposal_files_paths = glob.glob(pathname='../proposal_files/3dce_proposal_files/proposals_all_lesions/*.mat')
    ...
    proposal_files_paths_lesion_types = glob.glob(pathname='../proposal_files/3dce_proposal_files/proposals_lesion_types_and_size/*[OV|KD|LV|LU].mat')
    ...
    proposal_files_paths_lesion_sizes = glob.glob(pathname='../proposal_files/3dce_proposal_files/proposals_lesion_types_and_size/*size*.mat')
